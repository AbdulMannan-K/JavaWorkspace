...
public class Controller {
    ...
    public void makeMove(MouseEvent mouseEvent) throws IOException {
        ...
        if(l.getText().equals("X")||l.getText().equals("O")){
            ...
            if (!isTurn)
                l.setText(InfoController.player1.getIdentity());
            else
                l.setText(InfoController.player2.getIdentity());
            isTurn = !isTurn;
        }
        ...
        if (checkStatus().equals(true)) {
            winner.setText(InfoController.player1.getName()+" has won the Game");
            reset.setDisable(false);
        } else if (checkStatus().equals(false)) {
            winner.setText(InfoController.player2.getName()+" has won the Game");
            reset.setDisable(false);
        }
