...
public class Record {
    ...
    public void setNewPeopleVaccinated() {
        for(int i=0 ; i < AllRecord.Allrecords.size() ; i++){
            ...
            else if(AllRecord.Allrecords.get(i).getCountryName().equals(this.countryName) && AllRecord.Allrecords.get(i).getDate().equals(this.date) && AllRecord.Allrecords.get(i-1).getCountryName().equals(this.countryName)){
                this.newPeopleVaccinated=this.peopleVaccinated-AllRecord.Allrecords.get(i-1).getPeopleVaccinated();
                break;
            }else if(AllRecord.Allrecords.get(i).getCountryName().equals(this.countryName) && AllRecord.Allrecords.get(i).getDate().equals(this.date)) {
                this.newPeopleVaccinated = this.peopleVaccinated;
                break;
            }
        }
