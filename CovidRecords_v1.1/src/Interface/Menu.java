...
public class Menu {
    ...
    // if its first time the menu will not ask for continue or exit otherwise it will ask to exit or continue
    public void startMenu(boolean firstTime){
        int choice = 1;

        // Below is the whole menu with check to see if user enter right data or program will ask the user until he/she inputs right data
        if(!firstTime) {
            do {
    ...
    // this funtion show menu if user wants no range grouping method
