...
//		frame.getContentPane().setBackground((new Color(135, 206, 235)));
		...
		subHeaderPanel.setBackground(new Color(240,248,255));
		...
		moneybtn.setBackground(new Color(240,248,255));
		...
		superPanel.setBackground((new Color(135, 206, 235)));
		...
		subPanel.setBackground((new Color(135, 206, 235)));
		...
		for(int i =0 ; i < panels.length; i++) {
			...
			panels[i].setBackground(new Color(240,248,255));
			...
			completed.setBackground(new Color(135, 206, 235));
